class BoardTraverser {
  ...
  static accept(board, cellVisitor) {
    BoardTraverser.traverseColumn(board, cellVisitor);
    cellVisitor.reset();
    BoardTraverser.traverseRow(board, cellVisitor);
    cellVisitor.reset();
    BoardTraverser.traverseDiffDiagonal(board, cellVisitor);
    cellVisitor.reset();
    BoardTraverser.traverseSumDiagonal(board, cellVisitor);
    cellVisitor.reset();
  }
